...
for (i in 106:115) {
dat[,i]<-factor(dat[,i], levels = lvl_liklegt)
}
...
## II. hluti: Menntun og menntunarþörf

### `r str_wrap(q_text[13,2],width=900)`
\newpage
...
for(i in 106:115){
  ...
  my_plot<-ggplot(
    ...
    labs(title = str_wrap(q_item[i,4], width = 64) ,subtitle = "Mun sækja menntun")+
    theme_classic()+
