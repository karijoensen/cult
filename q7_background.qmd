...
grn_plt_5_7<-c("#d9f0a3"
,"#addd8e",  
"#78c679"
,"#41ab5d"
,"#238443","#ffffe5","#ffffe5")
...
```{r, echo=FALSE, eval=TRUE, results='asis'}
# Spurning 7.1-7.3
# Mín skipulagsheild líður fyrir að vera of smá
# Sameining við aðra stofnun / stofnanir væri jákvæð fyrir mína skipulagsheild
# Starfsumhverfi mitt býður uppá nægilegan faglegan stuðning
for(i in 69:71){
